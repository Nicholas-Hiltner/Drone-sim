...
class Drone : public IEntity {
 public:
  ...
  bool getGoCharge() { return goCharge; }

  void setToCharger(IStrategy* strat);

  IStrategy* getToCharger() { return toCharger; }

  void setCharging(bool need);

  void setGoCharge(bool go);
